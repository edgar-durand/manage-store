    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.CharField(blank=True, max_length=150, null=True, verbose_name='photo')),
                ('street', models.CharField(blank=True, max_length=150, null=True, verbose_name='street')),
                ('number', models.CharField(blank=True, max_length=150, null=True, verbose_name='number')),
                ('between', models.CharField(blank=True, max_length=150, null=True, verbose_name='between')),
                ...
                ('status_message', models.CharField(blank=True, max_length=150, null=True, verbose_name='status_message')),
        ...
        migrations.AddField(
            model_name='product',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prod_user', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='movements_account',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(verbose_name='date')),
